...
#define INTENSITY 0.015		// Motion blur intensity [0.010 0.015 0.020 0.035 0.050]
#define FPS 60				// Frames per second the effect is going to be running at [30 60 120 144 165 240 500 1000 2000]
...
void main() {
	...
	vec2 velocity = (currentPosition - previousPosition).st * (INTENSITY * (1.25 * (FPS / 60.0)));
